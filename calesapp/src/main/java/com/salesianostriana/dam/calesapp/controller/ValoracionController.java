...
public class ValoracionController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Valoraciones encontradas", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ValoracionDTO.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Valoracion encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ValoracionDTO.class))),
                        @ApiResponse(responseCode = "404", description = "Valoracion no encontrada"),
                        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
        })
        public ResponseEntity<ValoracionDTO> getValoracionById(
                        @Parameter(description = "ID de la valoracion a buscar", required = true) @PathVariable("id") Long id) {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Valoración creada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ValoracionDTO.class))),
                        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Valoración actualizada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ValoracionDTO.class))),
                        @ApiResponse(responseCode = "404", description = "Valoracion no encontrada"),
                        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
        })
        public ResponseEntity<ValoracionDTO> updateValoracion(
                        @Parameter(description = "ID de la valoracion a actualizar", required = true) @PathVariable("id") Long id,
                        @Parameter(description = "Datos del valoracion a actualizar", required = true) @RequestBody CreateUpdateValoracionDTO valoracionDTO) {
        ...
        public ResponseEntity<Boolean> deleteValoracion(
                        @Parameter(description = "ID de la valoracion a eliminar", required = true) @PathVariable("id") Long id) {
