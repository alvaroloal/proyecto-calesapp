...
public class ServicioController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServicioDTO.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Servicio encontrado", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServicioDTO.class))),
                        @ApiResponse(responseCode = "404", description = "Servicio no encontrado")
        })
        public ResponseEntity<ServicioDTO> getServicioById(
                        @Parameter(description = "ID del servicio a buscar", required = true) @PathVariable("id") Long id) {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Servicio creada con éxito", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServicioDTO.class))),
                        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
        })
        public ResponseEntity<ServicioDTO> createServicio(
                        @Parameter(description = "Datos del servicio a crear", required = true) @RequestBody @Valid CreateUpdateServicioDTO servicioDTO) {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Servicio actualizado con éxito", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServicioDTO.class))),
                        @ApiResponse(responseCode = "404", description = "Servicio no encontrada"),
                        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
        })
        public ResponseEntity<ServicioDTO> updateServicio(
                        @Parameter(description = "ID del servicio a actualizar", required = true) @PathVariable("id") Long id,
                        @Parameter(description = "Nuevos datos del servicio", required = true) @RequestBody CreateUpdateServicioDTO servicioDTO) {
        ...
        public ResponseEntity<Void> deleteServicio(
                        @Parameter(description = "ID del servicio a eliminar", required = true) @PathVariable("id") Long id) {
