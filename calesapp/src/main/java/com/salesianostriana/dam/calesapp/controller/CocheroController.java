...
public class CocheroController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de cocheros obtenida con éxito",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = CocheroDTO.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Cochero encontrado",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = CocheroDTO.class))),
            @ApiResponse(responseCode = "404", description = "Cochero no encontrada")
    })
    public ResponseEntity<CocheroDTO> getCocheroById(
            @Parameter(description = "ID del cochero a buscar", required = true)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Cochero creado con éxito",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = CocheroDTO.class))),
            @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    })
    public ResponseEntity<CocheroDTO> createCochero(
            @Parameter(description = "Datos del cochero a crear", required = true)
            @RequestBody CreateUpdateCocheroDTO cocheroDTO) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Cochero actualizada con éxito",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = CocheroDTO.class))),
    ...
    public ResponseEntity<CocheroDTO> updateCochero(
            @Parameter(description = "ID del cochero a actualizar", required = true)
            @PathVariable("id") Long id,
            @Parameter(description = "Nuevos datos del cochero", required = true)
            @RequestBody CreateUpdateCocheroDTO cocheroDTO) {
    ...
    public ResponseEntity<Void> deleteCochero(
            @Parameter(description = "ID del cochero a eliminar", required = true)
            @PathVariable("id") Long id) {
